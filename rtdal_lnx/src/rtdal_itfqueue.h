...
int rtdal_itfqueue_create(h_itf_t obj, string address);
...
int rtdal_itfqueue_put_pkt(h_itf_t obj, h_pkt_t* ptr);
h_pkt_t* rtdal_itfqueue_get_pkt(h_itf_t obj);
int rtdal_itfqueue_release_pkt(h_itf_t obj, h_pkt_t* ptr);
