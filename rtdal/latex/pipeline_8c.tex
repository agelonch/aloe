\hypertarget{pipeline_8c}{\section{/home/ismael/aloe\-\_\-ws/aloe\-\_\-git/rtdal\-\_\-lnx/src/pipeline.c File Reference}
\label{pipeline_8c}\index{/home/ismael/aloe\-\_\-ws/aloe\-\_\-git/rtdal\-\_\-lnx/src/pipeline.\-c@{/home/ismael/aloe\-\_\-ws/aloe\-\_\-git/rtdal\-\_\-lnx/src/pipeline.\-c}}
}
...
{\ttfamily \#include \char`\"{}pipeline\-\_\-sync.\-h\char`\"{}}\\*
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \hyperlink{pipeline_8c_a644d25013c5885243e33edd9e7c61678}{pipeline\-\_\-initialize} (int \-\_\-num\-\_\-pipelines)
\item 
void \hyperlink{pipeline_8c_adacbb7e165cf559489ff53309ed54bc6}{pipeline\-\_\-sync\-\_\-threads} ()
\item 
void \hyperlink{pipeline_8c_aa9b233cb90be7c46fe70942a92cc48a3}{pipeline\-\_\-run\-\_\-from\-\_\-timer} (void $\ast$arg, struct timespec $\ast$time)
\item 
void $\ast$ \hyperlink{pipeline_8c_a767c65ec7777bc4199a77827f1e81a72}{pipeline\-\_\-run\-\_\-thread} (void $\ast$self)
\item 
int \hyperlink{pipeline_8c_aaa0d27030e4683b82ffe9d5651b5c97c}{pipeline\-\_\-recover\-\_\-thread} (\hyperlink{structpipeline__t}{pipeline\-\_\-t} $\ast$obj)
...
int \hyperlink{pipeline_8c_a02037b265fa3ed27bf0a7d75d7813292}{pipeline\-\_\-rt\-\_\-fault} (\hyperlink{structpipeline__t}{pipeline\-\_\-t} $\ast$obj)
\begin{DoxyCompactList}\small\item\em Called when there is an rtfault in the pipeline. \end{DoxyCompactList}\item 
int \hyperlink{pipeline_8c_a615ac86c6cff54ffa2edb1bf1606729c}{pipeline\-\_\-add} (\hyperlink{structpipeline__t}{pipeline\-\_\-t} $\ast$obj, \hyperlink{rtdal__process_8h_aae6bdd48dcdbb9e74bbfb3dd6cd72b2a}{rtdal\-\_\-process\-\_\-t} $\ast$process)
\item 
int \hyperlink{pipeline_8c_ae95c1483a8fa6f94477e280a52fdfe78}{pipeline\-\_\-remove} (\hyperlink{structpipeline__t}{pipeline\-\_\-t} $\ast$obj, \hyperlink{rtdal__process_8h_aae6bdd48dcdbb9e74bbfb3dd6cd72b2a}{rtdal\-\_\-process\-\_\-t} $\ast$proc)
\end{DoxyCompactItemize}
\subsection*{Variables}
\begin{DoxyCompactItemize}
\item 
int \hyperlink{pipeline_8c_a095300387faf6c941bf15eebbb9a857d}{waveforms\-\_\-notified\-\_\-failure} \mbox{[}\hyperlink{rtdal__kernel_8h_a773bdf5491daa0c62f84ea2fc8627731}{M\-A\-X\-\_\-\-W\-A\-V\-E\-F\-O\-R\-M\-S}\mbox{]}
\end{DoxyCompactItemize}


\subsection{Function Documentation}
\hypertarget{pipeline_8c_a615ac86c6cff54ffa2edb1bf1606729c}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-add@{pipeline\-\_\-add}}
\index{pipeline\-\_\-add@{pipeline\-\_\-add}!pipeline.c@{pipeline.\-c}}
...
)}}\label{pipeline_8c_a615ac86c6cff54ffa2edb1bf1606729c}
...
\hypertarget{pipeline_8c_a644d25013c5885243e33edd9e7c61678}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-initialize@{pipeline\-\_\-initialize}}
\index{pipeline\-\_\-initialize@{pipeline\-\_\-initialize}!pipeline.c@{pipeline.\-c}}
...
\end{DoxyParamCaption}
)}}\label{pipeline_8c_a644d25013c5885243e33edd9e7c61678}
...
\hypertarget{pipeline_8c_aaa0d27030e4683b82ffe9d5651b5c97c}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-recover\-\_\-thread@{pipeline\-\_\-recover\-\_\-thread}}
\index{pipeline\-\_\-recover\-\_\-thread@{pipeline\-\_\-recover\-\_\-thread}!pipeline.c@{pipeline.\-c}}
\subsubsection[{pipeline\-\_\-recover\-\_\-thread}]{\setlength{\rightskip}{0pt plus 5cm}int pipeline\-\_\-recover\-\_\-thread (
\begin{DoxyParamCaption}
\item[{{\bf pipeline\-\_\-t} $\ast$}]{obj}
\end{DoxyParamCaption}
)}}\label{pipeline_8c_aaa0d27030e4683b82ffe9d5651b5c97c}
...
\hypertarget{pipeline_8c_ae95c1483a8fa6f94477e280a52fdfe78}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-remove@{pipeline\-\_\-remove}}
\index{pipeline\-\_\-remove@{pipeline\-\_\-remove}!pipeline.c@{pipeline.\-c}}
...
\end{DoxyParamCaption}
)}}\label{pipeline_8c_ae95c1483a8fa6f94477e280a52fdfe78}
...
\hypertarget{pipeline_8c_a02037b265fa3ed27bf0a7d75d7813292}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-rt\-\_\-fault@{pipeline\-\_\-rt\-\_\-fault}}
\index{pipeline\-\_\-rt\-\_\-fault@{pipeline\-\_\-rt\-\_\-fault}!pipeline.c@{pipeline.\-c}}
\subsubsection[{pipeline\-\_\-rt\-\_\-fault}]{\setlength{\rightskip}{0pt plus 5cm}int pipeline\-\_\-rt\-\_\-fault (
\begin{DoxyParamCaption}
\item[{{\bf pipeline\-\_\-t} $\ast$}]{obj}
\end{DoxyParamCaption}
)}}\label{pipeline_8c_a02037b265fa3ed27bf0a7d75d7813292}
...
\hypertarget{pipeline_8c_aa9b233cb90be7c46fe70942a92cc48a3}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-run\-\_\-from\-\_\-timer@{pipeline\-\_\-run\-\_\-from\-\_\-timer}}
\index{pipeline\-\_\-run\-\_\-from\-\_\-timer@{pipeline\-\_\-run\-\_\-from\-\_\-timer}!pipeline.c@{pipeline.\-c}}
...
\end{DoxyParamCaption}
)}}\label{pipeline_8c_aa9b233cb90be7c46fe70942a92cc48a3}
...
\hypertarget{pipeline_8c_a767c65ec7777bc4199a77827f1e81a72}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-run\-\_\-thread@{pipeline\-\_\-run\-\_\-thread}}
\index{pipeline\-\_\-run\-\_\-thread@{pipeline\-\_\-run\-\_\-thread}!pipeline.c@{pipeline.\-c}}
\subsubsection[{pipeline\-\_\-run\-\_\-thread}]{\setlength{\rightskip}{0pt plus 5cm}void$\ast$ pipeline\-\_\-run\-\_\-thread (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{self}
\end{DoxyParamCaption}
)}}\label{pipeline_8c_a767c65ec7777bc4199a77827f1e81a72}
...
\hypertarget{pipeline_8c_adacbb7e165cf559489ff53309ed54bc6}{\index{pipeline.\-c@{pipeline.\-c}!pipeline\-\_\-sync\-\_\-threads@{pipeline\-\_\-sync\-\_\-threads}}
\index{pipeline\-\_\-sync\-\_\-threads@{pipeline\-\_\-sync\-\_\-threads}!pipeline.c@{pipeline.\-c}}
\subsubsection[{pipeline\-\_\-sync\-\_\-threads}]{\setlength{\rightskip}{0pt plus 5cm}void pipeline\-\_\-sync\-\_\-threads (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{pipeline_8c_adacbb7e165cf559489ff53309ed54bc6}
...
\hypertarget{pipeline_8c_a095300387faf6c941bf15eebbb9a857d}{\index{pipeline.\-c@{pipeline.\-c}!waveforms\-\_\-notified\-\_\-failure@{waveforms\-\_\-notified\-\_\-failure}}
\index{waveforms\-\_\-notified\-\_\-failure@{waveforms\-\_\-notified\-\_\-failure}!pipeline.c@{pipeline.\-c}}
\subsubsection[{waveforms\-\_\-notified\-\_\-failure}]{\setlength{\rightskip}{0pt plus 5cm}int waveforms\-\_\-notified\-\_\-failure\mbox{[}{\bf M\-A\-X\-\_\-\-W\-A\-V\-E\-F\-O\-R\-M\-S}\mbox{]}}}\label{pipeline_8c_a095300387faf6c941bf15eebbb9a857d}
